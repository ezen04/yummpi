<!-- 배치 위치: .github/PULL_REQUEST_TEMPLATE.md -->
...
- [ ] 공용 자원(schema.prisma / packages/types / server.js / .github) 변경 시 사전 공지했다
...
- [ ] 새 API가 있다면 적대적 테스트 케이스 1개 이상 추가 (`harness/security-tests.md` 기준)
