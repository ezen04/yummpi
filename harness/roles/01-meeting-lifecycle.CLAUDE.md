...
> 배치 위치: `apps/web/src/features/meeting/CLAUDE.md` (골격 확정 후 경로 조정)
...
apps/api/prisma/schema.prisma  (스키마 오너 — 단, 변경 전 전원 리뷰 필수)
...
| `features/vote/**`, `server.js`(Socket.io), `api/.../votes/**` | ③ |
