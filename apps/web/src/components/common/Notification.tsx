...
export function Notification({ variant, title, body, icon, onClick }: NotificationProps) {
  ...
  return (
    ...
    >
      ...
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
        <path d="M7.5 5L12.5 10L7.5 15" stroke="var(--label-assistive)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </div>
  );
}
